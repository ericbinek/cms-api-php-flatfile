...
{
    public const TYPE_NAME = 'ImageObject';
    public const COLLECTION_FILE = 'image-objects.json';
    ...
    public const SEARCHABLE_FIELDS = ['name', 'caption', 'description', 'encodingFormat'];
    public const SORTABLE_FIELDS = ['dateCreated', 'dateModified', 'name', 'caption', 'description', 'contentUrl', 'encodingFormat', 'uploadDate', 'license'];

    // Properties whose combined value must be unique across the collection.
    // Empty when the entity allows duplicates.
    public const UNIQUE_KEY = ['contentUrl'];

    private const SYSTEM_FIELDS = ['id', 'dateCreated', 'dateModified', '@context', '@type'];

    private const REF_COLLECTIONS = ['Person' => 'persons.json'];
