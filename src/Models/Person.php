...
final class Person
{
    ...
    public const COLLECTION_FILE = 'persons.json';
    ...
    public const SEARCHABLE_FIELDS = ['name', 'givenName', 'familyName', 'alternateName', 'email', 'description', 'jobTitle'];
    public const SORTABLE_FIELDS = ['dateCreated', 'dateModified', 'name', 'givenName', 'familyName', 'alternateName', 'email', 'url', 'description', 'jobTitle'];
