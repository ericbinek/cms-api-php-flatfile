...
{
    public const TYPE_NAME = 'CategoryCode';
    ...
    public const REQUIRED_FIELDS = ['name', 'codeValue', 'inCodeSet'];
    public const SEARCHABLE_FIELDS = ['name', 'description', 'codeValue'];
    public const SORTABLE_FIELDS = ['dateCreated', 'dateModified', 'name', 'description', 'codeValue', 'url'];

    // Properties whose combined value must be unique across the collection.
    // Empty when the entity allows duplicates.
    public const UNIQUE_KEY = ['codeValue', 'inCodeSet'];

    private const SYSTEM_FIELDS = ['id', 'dateCreated', 'dateModified', '@context', '@type'];

    private const REF_COLLECTIONS = ['CategoryCodeSet' => 'category-code-sets.json'];
