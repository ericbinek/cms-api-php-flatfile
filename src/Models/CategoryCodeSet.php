...
{
    public const TYPE_NAME = 'CategoryCodeSet';
    public const COLLECTION_FILE = 'category-code-sets.json';
    ...
    public const SORTABLE_FIELDS = ['dateCreated', 'dateModified', 'name', 'description', 'url'];

    private const SYSTEM_FIELDS = ['id', 'dateCreated', 'dateModified', '@context', '@type'];

    private const REF_COLLECTIONS = [];
