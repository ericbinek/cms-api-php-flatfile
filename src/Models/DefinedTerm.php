...
final class DefinedTerm
{
    public const TYPE_NAME = 'DefinedTerm';
    public const COLLECTION_FILE = 'defined-terms.json';
    ...
    public const REQUIRED_FIELDS = ['name', 'termCode', 'inDefinedTermSet'];
    public const SEARCHABLE_FIELDS = ['name', 'description', 'termCode'];
    public const SORTABLE_FIELDS = ['dateCreated', 'dateModified', 'name', 'description', 'termCode', 'url'];

    // Properties whose combined value must be unique across the collection.
    // Empty when the entity allows duplicates.
    public const UNIQUE_KEY = ['termCode', 'inDefinedTermSet'];

    private const SYSTEM_FIELDS = ['id', 'dateCreated', 'dateModified', '@context', '@type'];

    private const REF_COLLECTIONS = ['DefinedTermSet' => 'defined-term-sets.json'];
